...
$statement = $pdo->prepare('SELECT notification_id, message, notification_type, created_at, is_read FROM notifications WHERE user_id = ? ORDER BY created_at DESC LIMIT 30');
